            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12">
                        <SectionTitle
                            title="Time Sayacı"
                            subtitle="Alanında Uzman"
                            description="Time Dijital, sunduğu yenilikçi sanal destekle müşterilerine çeşitli hizmetler sunarak teknolojideki ilerlemeye öncülük ediyor; geleceği şimdi yaşatıyor."
                            color="extra08-color"
                            alignment="center"
                        />
                    </div>
